...
<ul className='flex flex-col gap-[8px] mr-[12.2px]'>
    <li className='flex items-center text-[13px] text-grey-body font-medium'><span className='inline-block mr-[12.2px] w-[16px] h-[16px] flex items-center justify-center '><img src={bullet} alt="" /></span>I will learn your audit process</li>
    <li className='flex items-center text-[13px] text-grey-body font-medium'><span className='inline-block mr-[12.2px] w-[16px] h-[16px] flex items-center justify-center '><img src={bullet} alt="" /></span>I will carry out the audit in-person</li>
    <li className='flex items-center text-[13px] text-grey-body font-medium'><span className='inline-block mr-[12.2px] w-[16px] h-[16px] flex items-center justify-center '><img src={bullet} alt="" /></span>
Audit report</li>
    <li className='flex items-center text-[13px] text-grey-body font-medium'><span className='inline-block mr-[12.2px] w-[16px] h-[16px] flex items-center justify-center '><img src={bullet} alt="" /></span>Non-conformance report</li>
