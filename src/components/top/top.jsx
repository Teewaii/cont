        ...
        <div className='relative'>
            ...
            lg:w-[234px] pr[328.5px] z-[30]">
                ...
                <div className="flex flex-row justify-end gap-[40px] items-center">
                    ...
                    <div className="hidden lg:flex searchbar mx-0 ">
                ...
                <div className="menu-icon w-[24px] h-[20px] lg:hidden z-40 flex justify-center items-center" onClick={toggleMenu}>
                    {toggle ? <img className='w-full cursor-pointer' src={hamburger} alt="hamburger" /> :
                        <img className='w-full cursor-pointer' src={close} alt="close-icon" />}
                </div>
            </div>
