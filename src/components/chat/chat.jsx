...
export default function
    () {
    return (
        <div className=" chatContainer xl:flex flex-col items-center">
            <div className='card px-[18px]  border-[1px] border-grey100 rounded-[5px] max-w-[800px] lg:min-w-[470px]  mb-[20px]'>
                <div className="head flex  justify-between items-center mt-[18px] mb-[63px] ">
                    <div className="user flex items-center gap-[6px]">
                        <div className="shot">
                        ...
                        <div className=" flex flex-col gap-[1px]">
                            <div className="name flex items-center">
                                ...
                                <p className='hidden  font-semibold text-grey-body lg:inline-block mr-[2px] text-[9px]' >14:02</p><span className='text-grey300 text-[9px] hidden lg:block'> Local time</span>
                            </div>
                            <small className='hidden lg:block text-grey300  text-[9px]'>Average response time:<span className='font-semibold text-grey-body ml-[2px] text-[9px]'>3 hours</span></small>
                        </div>
                    </div>
                    <div className="open">
